...
#Regex pattern below will need to be adjusted for the particular names of the folders generated with bulk-submitter

for item in items:
    if os.path.isdir(item) and re.search(r'^alpha-a.*', item):
        print(item)
        os.chdir(item)
